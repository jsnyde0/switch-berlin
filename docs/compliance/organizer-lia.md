...
- **Events are already public.** Organizers have voluntarily published their events on Telegram channels and Instagram, which are accessible without login to any member of the public. Kinky Bubbles does not expose any data that was not already in public circulation.
...
Organizers who publish events on public Telegram channels or Instagram accounts do so with the expectation that those announcements will be seen and shared. Appearing in a curated community directory is consistent with, and a natural extension of, that expectation. Organizers acting in a public capacity (promoting events to the general public or to community members) are treated differently from private individuals under GDPR recital 47.
...
- **No automated profiling or scoring** of organizers occurs.
