...
# Hand-edited to add backfill step (sb-wz8m.2 cutover migration).
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        #
        # Idempotent DROP COLUMN IF EXISTS (not RemoveField) — sb-vixx, 2026-06-03.
        # The syndication migration lineage was squashed/refronted during the
        # sb-a4u epic (0001_initial rewritten in e940abb to fold these four
